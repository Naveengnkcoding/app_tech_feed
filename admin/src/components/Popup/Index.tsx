  ...
  return (
    <div
      ...
      <div 
        ...
        <div
          className='relative w-full h-[80vh] justify-center items-center md:h-[40vh] md:w-full lg:h-[80vh] xl:h-[80vh] 2xl:h-[80vh] xsm:h-[60vh] xsm:w-full 2xsm:h-[60vh] 2xsm:w-full'>
          <h2
