        ...
        <table className=" w-full text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
          ...
          <tbody>
            ...
            <tr className="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">Bill gates</td>
            ...
            <tr className="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">Sundar pichai</td>
              <td className="px-6 py-4">London,UK</td>
              <td className="px-6 py-4">GST</td>
              <td className="px-6 py-4">
                <a className="text-gray-900">Phone number</a>
            ...
            <tr className="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">Name</td>
              <td className="px-6 py-4">Bengaluru,India</td>
              <td className="px-6 py-4">GST</td>
              <td className="px-6 py-4">
            ...
            <tr className="border-b bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">Name</td>
              <td className="px-6 py-4">Chennai,India.</td>
              <td className="px-6 py-4">GST</td>
              <td className="px-6 py-4">
                <a className="text-gray-900">Phone number</a>
              </td>
            ...
            <tr className="border-b bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">Name</td>
              <td className="px-6 py-4">Coimbatore,India.</td>
              <td className="px-6 py-4">GST</td>
              <td className="px-6 py-4">
                <a className="text-gray-900">Phone number</a>
              </td>
